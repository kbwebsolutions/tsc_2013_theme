				...
				echo '<ul class="socials unstyled">';
					if ($hasblog) {
						...
						echo '<i class="fa fa-bookmark fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionblog','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hastwitter) {
						...
						echo '<i class="fa fa-twitter fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptiontwitter','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hasfacebook) {
						...
						echo '<i class="fa fa-facebook fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionfacebook','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hasyoutube) {
						...
						echo '<i class="fa fa-youtube fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionyoutube','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hasvimeo) {
						...
						echo '<i class="fa fa-vimeo-square fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionvimeo','theme_tsc_2013').'</span>';
						echo '</button>';
					}
					...
					if ($hasflickr) {
						...
						echo '<i class="fa fa-flickr fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionflickr','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($haspinterest) {
						...
						echo '<i class="fa fa-pinterest fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionpinterest','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hastumblr) {
						...
						echo '<i class="fa fa-tumblr fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptiontumblr','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hasinstagram) {
						...
						echo '<i class="fa fa-instagram fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptioninstagram','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hasvk) {
						...
						echo '<i class="fa fa-vk fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionvk','theme_tsc_2013').'</span>';
						echo '</a>';
					}
					...
					if ($hasskype) {
						...
						echo '<i class="fa fa-skype fa-inverse"></i>';
							echo '<span class="sr-only">'.get_string('socialnetworksicondescriptionskype','theme_tsc_2013').'</span>';
						echo '</a>';
					}
